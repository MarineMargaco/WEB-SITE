...
db.serialize(() => {
  ...
  db.run('CREATE TABLE Products (product_id INTEGER PRIMARY KEY AUTOINCREMENT, products TEXT, name TEXT, price TEXT, url TEXT, foreign_id INTEGER, FOREIGN KEY(foreign_id) REFERENCES Categories(categorie_id))');


  // INSERT COLUMNS >>CHAUSSURES DANS TABLE >> PRODUCTS
  // 
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'chaussure1', 'Escarpins bleu', '$30', 'https://images.unsplash.com/photo-1515347619252-60a4bf4fff4f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1363&q=80', 1);
  db.run('INSERT INTO Products (products, name, price, url,foreign_id) VALUES (?,?,?,?,?)', 'chaussure2', 'Bottines en Cuir noir', '$45,98', 'https://images.unsplash.com/photo-1494955464529-790512c65305?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1351&q=80', 1);

  // INSERT COLUMNS >>TSHIRTS DANS TABLE >> PRODUCTS 

  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'tshirt1', 'Tshirt blanc Imprimé', '$10', 'https://images.unsplash.com/photo-1522706604291-210a56c3b376?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 2);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'tshirt2', 'Tshirt orange Imprimé', '$12', 'https://images.unsplash.com/photo-1522098206893-cfda990aab1b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 2);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'tshirt3', 'Tshirt jaune Imprimé', '$13', 'https://images.unsplash.com/photo-1532296075534-cc428d395281?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 2);

  // INSERT COLUMNS >>ACCESSOIRES DANS TABLE >>PRODUCTS 

  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'accessoire1', 'Lunettes ', '$9,99', 'https://images.unsplash.com/photo-1475312775467-159e03aaa7cd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 3);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'accessoire2', 'Sac cuir rouge', '$150,50', 'https://images.unsplash.com/photo-1545069153-6c75c6c51442?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 3);

  // INSERT COLUMNS >>PANTALONS DANS TABLE >>PRODUCTS
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'pantalon1', 'Jean Troué', '$19,99', 'https://images.unsplash.com/photo-1454720503269-3a35c21bebc6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 4);


  // INSERT COLUMNS >>VESTES DANS TABLE >>PRODUCTS

  db.run('INSERT INTO Products (products, name, price,url ,foreign_id) VALUES (?,?,?,?,?)', 'veste1', 'Manteau rouge', '$20', 'https://images.unsplash.com/photo-1542148426-a7d0430f6a06?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 5);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'veste2', 'Perfecto Cuir', '$39,99', 'https://images.unsplash.com/photo-1541105672995-5da70dfff7f7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 5);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'veste3', 'Doudoune rouge', '$19', 'https://images.unsplash.com/photo-1542834759-b5dcaccbcde7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 5);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'veste4', 'Trench kaki', '$15', 'https://images.unsplash.com/photo-1542719018-ee28cbdc71ee?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 5);

  //INSERT COLUMNS >>PYJAMAS  DANS TABLE >>PRODUCTS

  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'pyjama1', 'Pyjama WonderWoman', '$560', 'https://tse3.mm.bing.net/th?id=OIP.ntQ2kXldZvaUjD2hd4gm-wDMEy&pid=15.1&P=0&w=300&h=300', 6);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'pyjama2', 'Pyjama Noël', '$21', 'http://demandware.edgesuite.net/sits_pod30/dw/image/v2/AAWW_PRD/on/demandware.static/-/Sites-ELIN-master/default/dwed39215c/647818802_x.jpg?sw=1692&sh=2000', 6);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'pyjama3', 'Onesie Zèbre', '$1550', 'http://www.freefisher.com/u_file/product/14_09_29/2014092909595685884.jpg', 6);

  //INSERT COLUMNS >>COSTUMES TABLE >>PRODUCTS

  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'costume1', 'Costume rouge', '$39,99', 'https://tse3.mm.bing.net/th?id=OIP.NmgMPadXKy6tK7qOp_vQZQHaLH&pid=15.1&P=0&w=300&h=300', 7);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'costume2', 'Costume bleu marine', '$39,99', 'https://tse3.mm.bing.net/th?id=OIP.v7F3Y274LU-dqtkRy0ogtwHaLH&pid=15.1&P=0&w=300&h=300', 7);

  //INSERT COLUMNS >>ROBES TABLE >>PRODUCTS 

  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'robe1', 'Robe orange à Motif ', '$15', 'https://images.unsplash.com/photo-1543310718-01540bebd143?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 8);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'robe2', 'Robe Longue noir', '$20', 'https://images.unsplash.com/photo-1551862512-aa5cf465bf32?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 8);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'robe3', 'Robe Fleurie', '$12', 'https://images.unsplash.com/photo-1550966992-5a9ac7b8972b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 8);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'robe4', 'Robe rouge', '$23', 'https://images.unsplash.com/photo-1542201912-20c8204c1869?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60', 8);


  //INSERT COLUMNS >>LINGERIES TABLE >>PRODUCTS 

  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'lingerie1', 'Brassière noir', '$60', 'https://images.unsplash.com/photo-1542996966-2e31c00bae31?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 9);
  db.run('INSERT INTO Products (products, name, price, url, foreign_id) VALUES (?,?,?,?,?)', 'lingerie2', 'Brassière Sport rouge', '$10', 'https://images.unsplash.com/photo-1518617840859-acd542e13a99?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1296&q=60', 9);
...
app.post('/comment', function (request, response) {
  ...
  db.run('INSERT INTO Products (comment) VALUES (?)', // Defini la requete SQL
    request.body.comment, // Je defini les valeurs envoyée a la BDD
